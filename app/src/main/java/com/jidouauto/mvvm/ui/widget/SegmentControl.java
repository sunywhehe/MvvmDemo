...
public class SegmentControl extends View {
    ...
    public SegmentControl(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTextBold = ta.getBoolean(R.styleable.SegmentControl_textBold, false);
         mCornerRadius = ta.getDimensionPixelSize(R.styleable.SegmentControl_android_radius, (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 5, context.getResources().getDisplayMetrics()));
