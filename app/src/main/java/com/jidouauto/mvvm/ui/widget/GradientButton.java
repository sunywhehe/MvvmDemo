...
public class GradientButton extends AppCompatButton {
    ...
    public GradientButton(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mBackgroundColor = a.getColor(R.styleable.GradientButton_fillColor, Color.TRANSPARENT);

        @Orientation
        int orientation = a.getInt(R.styleable.GradientButton_gbOrientation, TOP_BOTTOM);
        ...
        if(a.hasValue(R.styleable.GradientButton_gradient)) {
            ...
            mGradient = new int[] {
                    a.getColor(R.styleable.GradientButton_startColor, Color.BLUE),
                    a.getColor(R.styleable.GradientButton_endColor, Color.GREEN)
            };
        }
