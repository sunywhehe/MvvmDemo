...
public final class ResourceUtils {
    ...
    public static boolean copyFileFromAssets(final String assetsFilePath, final String destFilePath) {
        boolean res = true;
        try {
            String[] assets = AppUtils.getAppContext().getAssets().list(assetsFilePath);
            if (assets.length > 0) {
    ...
    public static String readAssets2String(final String assetsFilePath, final String charsetName) {
        InputStream is;
        try {
            is = AppUtils.getAppContext().getAssets().open(assetsFilePath);
        } catch (IOException e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static List<String> readAssets2List(final String assetsPath,
        ...
        try {
            return is2List(AppUtils.getAppContext().getResources().getAssets().open(assetsPath), charsetName);
        } catch (IOException e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static String readRaw2String(@RawRes final int resId, final String charsetName) {
        InputStream is = AppUtils.getAppContext().getResources().openRawResource(resId);
        byte[] bytes = is2Bytes(is);
        if (bytes == null) {
            return null;
        }
    ...
    public static List<String> readRaw2List(@RawRes final int resId,
                                            final String charsetName) {
        return is2List(AppUtils.getAppContext().getResources().openRawResource(resId), charsetName);
    }
